...
class LoginScreen: UIView {
    ...
    private weak var delegate: LoginScreenProtocols?
    
    public func delegate(delegate: LoginScreenProtocols) {
    ...
    func configTextFildsDelegate(delegate: UITextFieldDelegate) {
