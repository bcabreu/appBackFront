//
//  QotationEthTableViewCellScreen.swift
//  AppBackFront
//
...
class QuotationEthTableViewCellScreen: UIView {
    ...
    lazy var backgroundView: UIView = {
        ...
        view.layer.borderColor = UIColor(red: 131/255, green: 127/255, blue: 57/255, alpha: 1).cgColor
        return view
    }()
    ...
    private func configConstrainst() {
